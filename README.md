...
> A solo portfolio project: end-to-end financial analysis of 13 Kyrgyzstan 
> commercial banks — from raw annual report PDFs to a published Power BI dashboard.
...
followed by MBANK at 8.00%. Both banks improved year-over-year, while 
Demir Bank and Doscredo Bank saw notable ROA declines. For investors, 
a declining ROA signals that assets are growing faster than profits 
— an efficiency warning worth monitoring.
...
of 16.25% — near the sector bottom — raises the question of whether rapid asset expansion can be sustained without a proportional increase in its capital buffer.
...
Bank at 20.73%. For a depositor, this means Keremet Bank has the largest capital buffer to absorb potential losses before depositor funds are at risk.

**Efficiency:** MBANK operates at a cost-to-income ratio of 28.50% — 
exceptionally lean by any benchmark. For every 100 KGS of operating income generated, only 28.50 KGS is spent on running the bank — a level of cost efficiency that outperforms most international benchmarks.
...
by 17.79%, and net profit growth was the lowest in the sector. Doscredo Bank showed a similar deterioration — net profit fell 37.06% year-over-year while its cost-to-income ratio worsened from 73.30% to 83.51%, signaling simultaneous revenue decline and rising inefficiency.
...
Download `dashboard/kyrgyzstan-banks-2024.pbix` and open in Power BI Desktop.
